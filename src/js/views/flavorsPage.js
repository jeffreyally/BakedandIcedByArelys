...
export const FlavorsPage = () => {
    ...
    return (
        <div class="container">
            ...
            <span style={{ fontSize: '2.25rem', fontFamily: ' Bebas Neue, cursive' }}>Strawberry Cheesecake Sugar Cookie </span>
            ...
            <br></br>
            <span style={{ fontSize: '2.25rem', fontFamily: ' Bebas Neue, cursive' }}>Chocolate Sugar Cookies </span>
            ...
            <br></br>
            <span style={{ fontSize: '2.25rem', fontFamily: ' Bebas Neue, cursive' }}>Cookies and Cream Sugar Cookies </span>
            ...
            <br></br>
            <span style={{ fontSize: '2.25rem', fontFamily: ' Bebas Neue, cursive' }}>Lemon Sugar Cookies </span>
